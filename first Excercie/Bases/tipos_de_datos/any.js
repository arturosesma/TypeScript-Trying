...
(() => {
    ...
    let avengerString = avenger.charAt(0); // accedemos a los valores de un string aunque sea numero
    //otra forma de castear
    let avengerString2 = avenger.charAt(0); // accedemos a los valores de un string aunque sea numero
