...
(() => {
    //desestructuring o desestructuracion de objetos
    const avengers = {
    ...
    const printAvengerOtherForm = (_a) => {
        ...
        console.log(ironman, resto, resto.nick); //sabe que ya no tengo a ironman, esto es el operador rest. aplicado a un objeto
    };
